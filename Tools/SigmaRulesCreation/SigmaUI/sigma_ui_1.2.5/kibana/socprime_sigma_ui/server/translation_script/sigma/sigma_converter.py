...
##    workdir = os.path.normpath(main_dir + '/workdir/')
    ...
    try:
        ...
        try:
            ...
            if out_format == 'arcsight' or out_format == 'arcsight-esm':
                sigma_config = '-c ' + os.path.normpath(sigma_config_path + '/arcsight.yml')
            elif out_format == 'splunk':
                sigma_config = '-c ' + os.path.normpath(sigma_config_path + '/splunk-windows.yml')
            elif out_format == 'kibana':
                sigma_config = '-c ' + os.path.normpath(sigma_config_path + '/winlogbeat-modules-enabled.yml')
            ...
            elif out_format == "sumologic":
                sigma_config = '-c ' + os.path.normpath(sigma_config_path + '/sumologic.yml')
            elif out_format == "es-qs" or out_format == "elasticsearch-rule" :
                sigma_config = '-c ' + os.path.normpath(sigma_config_path + '/winlogbeat-modules-enabled.yml')
            elif out_format == "carbonblack":
                sigma_config = '-c ' + os.path.normpath(sigma_config_path + '/carbon-black.yml')
            elif out_format == "ala" or out_format == "ala-rule":
                sigma_config = '-c ' + os.path.normpath(sigma_config_path + '/ala.yml')
            else:
                sigma_config = ''
